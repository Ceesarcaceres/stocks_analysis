...
# Aparentemente é melhor usar somente dados do último ano. Isso pode ser devido ao entendimento do modelo, 
# se somente o comportamento mais recente esta envolvido no modelo, portanto é feita uma melhor predição.
...
# Novamente, checando que a data mais recente é a melhor opção. 
# Isso não significa que o modelo não está levando em conta todo o comportamento durante todo o período de tempo.
...
# Usando somente o preço de fechamento anterior mostra um erro mais aproximado do que usando todas as features, 
# então é uma boa opção para economizar  tempo enquanto está executando o código. De qualquer forma, 
# é recomendado implementar vários casos com diferentes features e escolher o caso com o menor erro.
